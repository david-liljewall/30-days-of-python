...
def menu():
    file_interactions.create_book_table()
...
def prompt_add_book():
    ...
    file_interactions.insert_book(name, author)

def list_books():
    for book in file_interactions.get_all_books():
...
def prompt_read_book():
    ...
    file_interactions.mark_book_as_read(name)


def prompt_delete_book():
    name = input('Enter the name of the book you wish to delete: ')

    file_interactions.delete_book(name)
