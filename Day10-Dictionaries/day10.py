...
# returns None since "grade" is not a dictionary key
print(student.get("grade"))

# returns an empty list if "grade" key NOT found
print(student.get("grade", []))
...
# adds a new key "age", and adds an item association with that key
student["age"] = 17
